...
export default function BidsOverview() {
  ...
  const totalBids = filteredProjects.length;
  const acceptedBids = filteredProjects.filter((p) => p.status === "Accepted").length;
  const pendingBids = filteredProjects.filter((p) => p.status === "Under Review").length;
  const totalAmount = filteredProjects.reduce((sum, p) => sum + p.bidAmount, 0);
  ...
  return (
    <div className="bids-overview-wrapper">
      ...
      <div className="bids-stats-section">
        <div className="bids-stat-card">
          <div className="bids-stat-label">Total Bids</div>
          <div className="bids-stat-value">{totalBids}</div>
        </div>
        <div className="bids-stat-card">
          <div className="bids-stat-label">Accepted</div>
          <div className="bids-stat-value bids-stat-accepted">{acceptedBids}</div>
        </div>
        <div className="bids-stat-card">
          <div className="bids-stat-label">Pending Review</div>
          <div className="bids-stat-value bids-stat-pending">{pendingBids}</div>
        </div>
        <div className="bids-stat-card">
          <div className="bids-stat-label">Total Amount</div>
          <div className="bids-stat-value bids-stat-amount">
